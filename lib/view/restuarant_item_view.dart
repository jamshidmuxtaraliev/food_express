...
class RestuarantItemView extends StatefulWidget {
  RestuarantModel item;

  RestuarantItemView({Key? key, required this.item}) : super(key: key);

  @override
  _RestuarantItemViewState createState() => _RestuarantItemViewState();
}

class _RestuarantItemViewState extends State<RestuarantItemView> {
  @override
